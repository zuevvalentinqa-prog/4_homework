...
console.log(5 != 5); // false - Оператор != — это нестрогое неравенство. Он проверяет: "не равны ли эти два значения?
console.log(5 !== '5'); // true - строгое неравенство, проверяет только значение, 5 = 5, равны ли два значения?
